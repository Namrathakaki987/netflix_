...
//             <h1 className='text-3xl font-bold'>Patel mernstack</h1>
//             <p>Lorem ipsum dolor sit amet consectetur adipisicing elitlaceat facilis dolorum id tempora tenetur!</p>
...
//                 <button className='flex mx-2 items-center px-6 py-2 bg-grey-500 bg-opacity-50  text-black rounded-md'><CiCircleInfo size="24px"/><span className='ml-1'>Watch more</span></button>
//             </div>
//         </div>
//     )
// }
