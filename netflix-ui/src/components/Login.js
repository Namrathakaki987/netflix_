...
//                 <img className="w-[100vw] h-[100vh]" src='https://th.bing.com/th/id/OIP.3PoCopw_b3fvq0Cq8ur3VwHaEK?w=736&h=414&rs=1&pid=ImgDetMain' alt='cover'/>
//             </div>
//             <form onSubmit={getInputData} className=' flex flex-col left-0 right-0 mx-auto items-center justify-center w-3/12 p-12 my-36 absolute bg-black opacity-90'>
...
//                     <p className='text-white mt-2 '>{isLogin? "New to Netflix?" : "Already have an account"}<span onClick={loginhandler} className='ml-1 text-blue font-medium'>{isLogin? "Signup":"Login"}</span></p>
